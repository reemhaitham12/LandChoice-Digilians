      ...
      <div className="glass-card rounded-3xl p-8 border border-white/10 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          ...
          <div className="flex flex-col gap-3 min-w-[170px]">
            <button className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-primary/20 text-primary border border-primary/30 hover:bg-primary/40 transition-all text-sm font-semibold">
              <FontAwesomeIcon icon={faPlus} /> Add to Compare
            </button>
            <button className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 text-white border border-white/10 hover:bg-white/10 transition-all text-sm font-semibold">
              <FontAwesomeIcon icon={faBolt} /> Check Eligibility
            </button>
            <button className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 text-slate-400 border border-white/5 hover:bg-white/5 hover:text-white transition-all text-sm font-semibold">
